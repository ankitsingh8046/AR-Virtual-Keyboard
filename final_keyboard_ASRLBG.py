...
hd = cv2.CascadeClassifier('hand.xml')
...
while True:
    ...
    cv2.putText(keyboard, "  ", (x_num+100,start_num_y-30),cv2.FONT_HERSHEY_PLAIN,2,(0,120,255),2)
    ...
    if cv2.waitKey(2) == 13:
        messagebox.showinfo( "Created By:","Ankit Singh Rathore")
